...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "DropDownList.php?list=".$_POST['list'];
//  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <tr>
    <td><form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
      <table width="100%" bgcolor="#BCFACC">
        <tr>
          <td>&nbsp;</td>
          <td nowrap="nowrap" class="subtitlebk">Add Drop Down Menu Item </td>
        </tr>

        <tr>
          <td class="BlackBold_14"><div align="right">List:</div></td>
          <td><input name="list" type="text" id="list" readonly="readonly"  value="<?php echo $_GET['list'] ?>"/></td>
        </tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><p>
            <input type="submit" name="Submit" value="Add DDL Item" />
          </p></td>
        </tr>
      </table>
