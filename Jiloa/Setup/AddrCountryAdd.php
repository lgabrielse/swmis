...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO country (country) VALUES (%s)",
  ...
  $insertGoTo = "AddrCountryView.php";
//  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <tr>
    <td><form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
      <table width="100%"  bgcolor="#BCFACC">
        <tr>
          <td>&nbsp;</td>
          <td class="subtitlebk">Add Country </td>
        </tr>

        <tr>
          <td class="BlackBold_14"><div align="right">Country:</div></td>
          <td><input name="country" type="text" id="country" autocomplete="off" /></td>
        </tr>
        <tr>
