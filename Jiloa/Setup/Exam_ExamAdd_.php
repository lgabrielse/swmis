...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO exam_exam (examname, seq, location, active, entrydt, entryby) VALUES (%s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_swmisconn, $swmisconn);
$query_location = "SELECT name FROM fee WHERE Active = 'Y' and dept = 'Records'  ORDER BY section, name ASC";
