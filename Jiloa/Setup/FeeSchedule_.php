...
$query_fees = "SELECT f.id, f.dept, f.`section`, f.name, f.descr, f.specid, f.fee, f.Active, s.name spname FROM fee f join specimens s on f.specid = s.id ORDER BY f.dept, f.section, f.name ASC";
    ...
    <td valign="top">
	 <table width="100%">
      ...
      <tr>
        ...
        <td class="subtitlebl"><div align="center">dept</div></td>
        <td class="subtitlebl"><div align="center">section</div></td>
        <td class="subtitlebl"><div align="center">name</div></td>
        <td class="subtitlebl"><div align="center">descr</div></td>
        <td class="subtitlebl"><div align="center">specid</div></td>
        <td class="subtitlebl">Specimen</td>
        <td class="subtitlebl"><div align="center">fee</div></td>
        <td class="subtitlebl">Active</td>
      </tr>
      <?php do { ?>
      <tr>
