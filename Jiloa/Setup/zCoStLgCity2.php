...
?>
    ...
    <td><table>
      ...
      <tr>
        <form id="form2" name="form2" method="post" action="CoStLgCity2.php">
          <td><input type="text" name="country2" id="country2" /></td>
          <?php if ($_SESSION['countryid']=='0') {?>
          <td nowrap="nowrap"><input type="hidden" name="MM_update" value="form2" />
            <input type="submit" name="button2" id="button2" value="Add Country" /></td>
          <?php } ?>
        </form>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <form id="form3" name="form3" method="post" action="CoStLgCity2.php">
          <td><input type="text" name="state2" id="state2" /></td>
          <?php if ($_SESSION['countryid'] != '0' AND $_SESSION['stateid'] == '0') {?>
          <td nowrap="nowrap"><input type="hidden" name="MM_update" value="form3" />
            <input type="submit" name="button3" id="button3" value="Add State" /></td>
          <?php } ?>
        </form>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <form id="form4" name="form4" method="post" action="CoStLgCity2.php">
          <td><input type="text" name="locgovt2" id="locgovt2" /></td>
          <?php if ($_SESSION['countryid'] != '0' AND $_SESSION['stateid'] != '0' AND $_SESSION['locgovtid'] == '0') {?>
          <td nowrap="nowrap"><input type="hidden" name="MM_update" value="form4" />
            <input type="submit" name="button4" id="button4" value="Add Loc Gov't" /></td>
          <?php } ?>
        </form>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <form id="form5" name="form5" method="post" action="CoStLgCity2.php">
          ...
          <td nowrap="nowrap"><input type="hidden" name="MM_update" value="form5" />
            <input type="submit" name="button5" id="button5" value="Add City" /></td>
          <?php }?>
        </form>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
