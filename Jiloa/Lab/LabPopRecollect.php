  ...
  $saved = "";
	...
	if (isset($_SERVER['QUERY_STRING'])) {
	  $editFormAction .= "?" . htmlentities($_SERVER['QUERY_STRING']);
		...
		if (isset($_POST['SubmitRec']) AND $_POST['SubmitRec']  == 'Confirm Recollect')  {
...
<body>
<div align="center" class="BlueBold_20">RECOLLECT</div>
<table width="300" border="0" align="center">
<form id="form1" name="form1" method="post" action="LabPopRecollect.php">
  <tr>
    <td><div align="center">
  ...
  <tr>
    ...
    <td colspan="2" bgcolor="#F8FDCE"><label>
		<input name="status" type="hidden" value="Recollect" />		
		<input name="ordid" type="hidden" value="<?php echo $_GET['ordid'] ?>" />		
		<input type="submit" name="SubmitRec" value="Confirm Recollect" />
    </label></td>
    </tr>
</form>
</table>
