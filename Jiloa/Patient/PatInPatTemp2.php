...
$Temps = array(
array('Celcius', 'Fahrenheit', "#ffffff"),
...
<?php
  for ($col = 0; $col < 28; $col++) {
?>
   <td align="center" bgcolor="<?php echo $Temps[$col][2] ?>" class="Black_1011"><?php echo $Temps[$col][$row] ?></td>
<?php } ?>
  </tr>
<?php } ?>
</table>
...
<table>
<?php
for ($row = 28; $row >-1; $row--) {
?>
 <tr>
<?php
  for ($col = 0; $col < 2; $col++) {
?>
   <td align="center" bgcolor="<?php echo $Temps[$row][2] ?>" class="Black_1011"><?php echo $Temps[$row][$col] ?></td>
<?php } ?>
  </tr>
<?php } ?>
</table>
...
<?php
  for ($col = 0; $col < 2; $col++) {
?>
   <td align="center" bgcolor="<?php echo $Temps2[$row][2] ?>" class="Black_1011"><?php echo $Temps2[$row][$col] ?></td>
<?php } ?>
  </tr>
<?php } ?>
</table>
