...
<!-- Begin PATIENT - PATIENT - PATIENT - PATIENT - PATIENT - PATIENT - PATIENT - PATIENT - PATIENT - PATIENT - PATIENT -   -->
  ...
  <table width="70%" align="center">
	  <tr>
	  	<td colspan="7" class ="BlueBold_18"><div align="center">Patient History</div></td>
	  </tr>
	  <tr>
...
?>
  <?php do { ?>
      ...
      <td colspan="6" bgcolor="#FFFDDA" nowrap="nowrap" title="ENTRY BY: <?php echo $row_notes['entryby']; ?>&#10;ENTRY DATE: <?php echo $row_notes['entrydt']; ?>&#10;Notes  ID: "<?php echo $row_notes['visitid']; ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_notes['notes']; ?></td>
