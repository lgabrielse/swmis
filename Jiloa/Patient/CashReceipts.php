...
<body>
<div align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		          <a href="../Reports/CashierReptMenu.php"><span class="navLink">Menu</span> </a>	                                            	        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
<?php 		mysql_select_db($database_swmisconn, $swmisconn);
		...
		$query_rcptord = "SELECT o.amtpaid oamtpaid, o.amtdue oamtdue, ro.amtdue roamtdue, ro.amtpaid roamtpaid, ro.unpaid, f.fee, f.id feeid, left(f.dept,3) dept, f.section, f.name, o.id orderid, o.rate from receipts r join rcptord ro on r.id = ro.rcptid join orders o on ro.ordid = o.id join fee f on o.feeid = f.id WHERE r.id = '" . $row_Recd['rid']."'";
