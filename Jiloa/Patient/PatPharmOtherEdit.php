...
$totalRows_myfee = mysql_num_rows($myfee);
  ...
  $updateSQL = sprintf("UPDATE orders SET feeid=%s, urgency=%s, doctor=%s, item=%s, quant=%s, ofee=%s, entryby=%s, entrydt=%s, comments=%s WHERE id=%s",
...
<form id="formrx2" name="formrx2" method="post" action="<?php echo $editFormAction; ?>"> 
    <table border="1"  bgcolor="#F8FDCE">
     ...
     <tr>
       <td colspan="4" nowrap="nowrap"><div align="center" class="BlueBold_20">EDIT DRUG / DONATION </div></td>
       </tr>
     <tr>
...
?>
	  ...
	  <tr>
	    <td nowrap="nowrap"><input name="Submit" type="submit" id="Submit" value="Edit Order" /></td>
	    </tr>
