...
<table width="80%" border="0">
  <tr>
    <td nowrap="nowrap" class="navLink">
      <div align="center">
    ...
    <td nowrap="nowrap" class="navLink"><div align="center">
      <?php //if($totalRows_patinfoview <= 0 and allow(21,3) == 1) { ?>
      <a href="javascript:void(0)" onclick="MM_openBrWindow('PatInPatFluidsOutAdd.php?mrn=<?php echo $_SESSION['mrn']; ?>&amp;vid=<?php echo $_SESSION['vid']; ?>','StatusView','scrollbars=yes,resizable=yes,width=550,height=200')">Add OUT</a>
      <?php // } ?>
    </div></td>
...
<?php   if($row_outfluid['dtto'] >= $_SESSION['seldate2']){ // For Selected greater than Date-->
