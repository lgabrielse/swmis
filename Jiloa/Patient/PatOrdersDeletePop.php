...
mysql_select_db($database_swmisconn, $swmisconn);
$query_ordedit = sprintf("Select o.id ordid, o.medrecnum, o.visitid, o.feeid, o.status, substr(o.urgency,1,1) urg, o.item, DATE_FORMAT(o.entrydt,'%%d-%%b-%%Y %%H:%%i') entrydt, o.entryby, Format(f.fee*(o.rate/100),0) as amtdue, o.rate, o.ratereason, o.amtpaid, f.dept, f.section, f.name, f.descr, f.fee FROM orders o join fee f on o.feeid = f.id WHERE o.id = %s", $row_ordered['id']);
    ...
    <td><form id="form1" name="form1" method="post" action="">
      <table width="100%" bgcolor="#FBD0D7">
        <tr>
          ...
          <td colspan="2" nowrap="nowrap"><div align="center" class="BlackBold_18">Order Delete&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
