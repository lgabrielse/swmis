...
<table align="center">
  ...
  <tr>
    <!-- display PDF button -->
    <td><input type="button" name = "button4" class="btngradblu75" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=PDF&pge=PatPDFView.php'" value=" PDFs (<?php echo $z; ?>) " size="5" /></td>
    ...
    <td><input name = "button8" class="btngradblu75" value="OP Notes(<?php echo $row_notes['notes']; ?>)" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&notepage=PatNotesAdd.php&notetype=OutPatient'" /></td>
    <?php }
	  else {?>
    <td><input name = "button9" class="btngradblu75"  value="OP Notes(<?php echo $row_notes['notes']; ?>)" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&notepage=PatNotesView.php&notetype=OutPatient'" /></td>
    <?php }?>
    <?php }?>
    <?php }?>
    <!-- display LAB ORDER button -->
    <?php if(allow(46,1) == 1) { ?>
    <td width="100px"><input name = "button22" class="btngradblu" value="Lab Orders(<?php echo $row_labs['labs']; ?>)" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=lab&pge=PatLabView.php'" /></td>
    <?php }?>
    <!-- display LAB RESULT button -->
    <td><input name="button" class="btngradblu75" value="Lab Results" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=lab&pge=PatLabResults.php'" /></td>
    <!-- display Radiology ORDER button -->
    <?php if(allow(47,1) == 1) { ?>
    <td width="100px"><input name = "button2" class="btngradblu" value="Rad Orders(<?php echo $row_rads['rads']; ?>)" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=lab&pge=PatRadView.php'" /></td>
    <?php }?>
    <!-- display PT ORDER button -->
    <?php if(allow(49,1) == 1) { ?>
    <td width="100px"><input name = "button2" class="btngradblu" value="PT Orders(<?php echo $row_pts['pts']; ?>)" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=lab&pge=PatPtView.php'" /></td>
    <?php }?>
    <!-- display Surgery ORDER button -->
    <?php if(allow(51,1) == 1) { ?>
    <td><input name = "button2" class="btngradblu100" value="Surg Orders(<?php echo $row_surgs['surgs']; ?>)" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=lab&pge=PatSurgView.php'" /></td>
    <?php }?>
    <!-- display Pharmacy button -->
    <?php if(allow(45,1) == 1) { ?>
    <td><div align="center">
      <input name="button3" class="btngradblu25" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=pharm&pge=PatPharmOrderView.php&patype=<?php echo $row_lastvisit['pat_type']; ?>'" value="Rx" size="1" maxlength="2" />
    </div></td>
    <?php }?>
    <!-- display Scheduling button -->
    <?php if(allow(29,1) == 1) { ?>
    <td nowrap="nowrap"><input name="button" class="btngradblu75" value="  Schedule" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=sched&pge=PatSchedule.php&loc=<?php echo $row_lastvisit['location']; ?>'" /></td>
    <!-- PatSchedView.php -->
    <?php }?>
    <!-- display History button -->
    <td nowrap="nowrap"><!--<input name="button7" class="btngradblu50" value="History" onclick="parent.location='PatShow1.php?mrn=<?php //echo $_SESSION['mrn']; ?>&vid=<?php //echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=hist&pge=PatHistView.php'" />-->
        <div align="center">
          <input name="button7" class="btngradblu50" value="History" onclick="window.open('PatHistAll.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>', '_blank');" />
        </div></td>
    <!-- display Orders button -->
    <?php if(allow(30,1) == 1) { ?>
    <td><div align="center">
      <input name="button" class="btngradblu50" value=" Orders " onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=hist&pge=PatOrdersView.php'" />
    </div></td>
    <?php }?>
    <?php if($row_lastvisit['pat_type'] == "OutPatient"){ ?>
    <td><input name="button6222" class="btngradblu75" value="AllNotes (<?php echo $row_allnotes['notes']; ?>)" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=inpat&pge=PatNotesView.php&notetype=%'" /></td>
    <?php }?>
  </tr>
  <!--((((((((((((((( ANTENATAL ))))))))))))   ((((((((((((((( ANTENATAL ))))))))))))-->
  ...
  <tr>
    <!-- display preg  button -->
    <?php if(allow(30,1) == 1) { ?>
    <td><input name="button6" class="btngradblu75" value="Preg view" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=ante&pge=PatAntePregView.php'" /></td>
    <td><input name="button5" class="btngradblu75" value="PrevPreg" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=ante&pge=PatAntePrevPregView.php'" /></td>
  </tr>
  <?php  }
	 }?>
  <!--((((((((((((((( InPatient ))))))))))))   ((((((((((((((( Inpatient ))))))))))))-->
  ...
  <tr>
    ...
    <?php // }?>
    <?php if(allow(44,1) == 1) { ?>
    <td ><input name="button622" class="btngradblu75" value="AllNotes(<?php echo $row_allnotes['notes']; ?>)" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=inpat&pge=PatNotesView.php&notetype=%'" /></td>
    <?php }?>
    <?php if(allow(38,1) == 1) { ?>
    <td ><input name="button623" class="btngradblu100" value="Doctor Notes" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=inpat&pge=PatNotesView.php&notetype=InpatientDoc'" /></td>
    <?php }?>
    <?php if(allow(36,1) == 1) { ?>
    <td ><input name="button62" class="btngradblu100" value="Nurse Orders" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo	 $_SESSION['vid']; ?>&visit=PatVisitView.php&act=inpat&pge=PatNurseOrderView.php'" /></td>
    <?php }?>
    <?php if(allow(37,1) == 1) { ?>
    <td ><input name="button622" class="btngradblu75" value="NurseNotes" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=inpat&pge=PatNotesView.php&notetype=InpatientNurse'" /></td>
    <?php }?>
    <?php //if(allow(39,1) == 1) { ?>
    ...
    <?php if(allow(40,1) == 1) { ?>
    <td><div align="center">
      <input name="button5" class="btngradblu75" value="   Vitals" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=inpat&pge=PatInPatVitals.php'" />
    </div></td>
    <?php }?>
    <?php if(allow(41,1) == 1) { ?>
    <td><input name="button5" class="btngradblu50" value="Meds" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=inpat&pge=PatInPatMeds.php&medid=%'" /></td>
    <?php }?>
    <?php if(allow(42,1) == 1) { ?>
    <td><div align="center">
      <input name="button52" class="btngradblu50" value=" Fluids" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=inpat&pge=PatInPatFluids.php'" />
    </div></td>
    <?php }?>
    <?php if(allow(43,1) == 1) { ?>
    <td ><input name="button62" class="btngradblu75" value="Discharge" onclick="parent.location='PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=inpat&pge=PatInPatDischView.php'" /></td>
    <?php }?>
  </tr>
  <?php  } ?>
</table>
