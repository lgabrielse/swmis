...
<body>
<h1 align="center">Radiology RESULTS ENTRY </h1>
	<table width="80%" align="center">
	  <tr>
	    <td>
		 <table width="40%" align="center">
          <form id="form1" name="form1" method="post" action="RadREOrders.php" > 
          <tr>
            <td width="5%">&nbsp;</td>
...
<!-- if (condition) {
  ...
  code to be executed if condition is false;
            ...
            <td nowrap="nowrap"><a href="../Patient/PatShow1.php?&mrn=<?php echo $row_orders['medrecnum']; ?>&vid=<?php echo $row_orders['vid']; ?>&ordid=<?php echo $row_orders['ordid']; ?>&visit=PatVisitView.php&act=inpat&pge=PatNotesViewPSR.php&notetype=Radiology">Result --></a> </td>

            <?php } elseif($row_orders['status'] == 'Resulted' AND allow(25,3) == 1) { ?>
            <td nowrap="nowrap"><a href="../Patient/PatShow1.php?&mrn=<?php echo $row_orders['medrecnum']; ?>&vid=<?php echo $row_orders['vid']; ?>&ordid=<?php echo $row_orders['ordid']; ?>&visit=PatVisitView.php&act=inpat&pge=PatNotesViewPSR.php&notetype=Radiology">Review --></a> </td>
            <?php } else { ?>
            ...
            <td title="BACK TO RESULTED"><a href="../Patient/PatShow1.php?&mrn=<?php echo $row_orders['medrecnum']; ?>&vid=<?php echo $row_orders['vid']; ?>&ordid=<?php echo $row_orders['ordid']; ?>&visit=PatVisitView.php&act=inpat&pge=PatNotesViewPSR.php&notetype=Radiology">Re-Review --></a> </td>
            <?php } else { ?>
            <td bgcolor="#f5f5f5" class="BlackBold_11">&nbsp;</td>
            <?php }  ?>
          </tr>
