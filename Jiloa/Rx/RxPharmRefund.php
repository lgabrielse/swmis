...
<form id="formrx3" name="formrx3" method="post" action="<?php echo $editFormAction; ?>"> 
    <table border="1" align="center"  bgcolor="#F8FDCE">
     ...
     <tr>
       <td colspan="4" nowrap="nowrap" class="BlueBold_20" title="Order status will be unchanged &#10;Billing status will become Refund"><div align="center">REFUND A DRUG </div></td>
       </tr>
     <tr>
	  ...
	  <tr>
		<td rowspan="2" nowrap="nowrap">Order Comments:<br />Order #: <?php echo $row_editdel['id']; ?><br />Only Comments can be edited</td>
	  ...
	  <tr>
	    <td nowrap="nowrap"><input name="Submit" type="submit" id="Submit" value="Refund" /></td>
	    </tr>
				...
				<input name="status" type="hidden" id="status" value="RxRefund" />
				<input name="billstatus" type="hidden" id="billstatus" value="Refund" />
