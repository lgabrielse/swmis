...
<form id="formrx3" name="formrx3" method="post" action="<?php echo $editFormAction; ?>"> 
    <table border="1" align="center"  bgcolor="#F8FDCE">
     ...
     <tr>
       <td colspan="4" nowrap="nowrap" class="BlueBold_20"><div align="center">REFERRED</div></td>
       </tr>
     <tr>
	  ...
	  <tr>
	    <td nowrap="nowrap"><input name="Submit" type="submit" id="Submit" value="Referrred" /></td>
	    </tr>
